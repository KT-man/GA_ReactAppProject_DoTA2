...
//--------------- bigInt required to manipulate 17 digit Steam Community ID
const bigInt = require("big-integer");

const ParentContainer = () => {
  //For further consolidation in the future
  ...
  //--------------------------- UseEffect to conditionally run converter function on search input. Function runs when search state is altered onChange
